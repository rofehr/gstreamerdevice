...
pipeline = gst_parse_launch("appsrc name=vdrsource ! decodebin name=demux demux. ! queue ! audioconvert ! audioresample ! autoaudiosink demux. ! videoconvert ! fbdevsink name=videosink" , NULL);
